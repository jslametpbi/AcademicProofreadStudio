...
const STORAGE_PROJECTS = 'aps_projects_v3';
const STORAGE_PACKAGES = 'aps_packages_v5';
const STORAGE_ACCESS = 'aps_secure_access_v2';
...
function demoProjectTemplate(){
  const documentText = "Generative AI for English for Specific Purposes: Undergraduate Students\u2019 Development of Discipline-Specific Vocabulary, Genre Awareness, and Communicative Confidence\n\nDewi Hidayati\n\nDepartment of Islamic Education, STAI Diponegoro Tulungagung, Tulungagung, East Java, Indonesia\n\nCorrespondence: Dewi Hidayati | Email: dewiaansugianto@gmail.com\n\nAbstract\n\nThis study investigates the effects of Generative Artificial Intelligence (GenAI)-integrated English for Specific Purposes (ESP) instruction on undergraduate students\u2019 discipline-specific vocabulary acquisition, genre awareness, and communicative confidence. Employing a mixed-methods quasi-experimental design, 45 undergraduate students from the Department of Islamic Education at STAI Diponegoro Tulungagung, Indonesia, were assigned to an experimental group (n = 23) receiving GenAI-assisted ESP instruction over eight weeks and a control group (n = 22) receiving conventional instruction. Quantitative data were collected using a Discipline-Specific Vocabulary Test, a Genre Awareness Assessment Rubric, and a Communicative Confidence Scale administered pre- and post-intervention, supplemented by semi-structured interviews with twelve purposively selected participants. Paired-samples and independent-samples t-tests revealed statistically significant and practically substantial gains in all three domains for the experimental group (p < .001), with large effect sizes for vocabulary acquisition (Cohen\u2019s d = 1.42), genre awareness (d = 1.53), and communicative confidence (d = 1.31). Qualitative analysis produced four emergent themes: scaffolded vocabulary discovery through iterative prompting, iterative genre negotiation as genre learning, reduced communicative anxiety via low-stakes AI interaction, and emerging critical-reflexive AI literacy. These findings advance theoretical understanding of AI-mediated language learning and offer evidence-based pedagogical implications for ESP practitioners in higher education.\n\nKeywords: Generative AI; English for Specific Purposes; discipline-specific vocabulary; genre awareness; communicative confidence\n\n1. Introduction\n\nThe proliferation of Generative Artificial Intelligence (GenAI) tools has fundamentally reconfigured the landscape of higher education language instruction, prompting urgent scholarly attention to their pedagogical affordances and limitations within English for Specific Purposes (ESP) contexts (Zhang & Huang, 2024; Smith, 2025; Mahapatra, 2024). ESP, distinguished from General English by its purposive orientation toward the linguistic demands of particular academic and professional domains, occupies a strategically pivotal position in the preparation of undergraduate learners for discipline-specific communicative practices (Ballance & Coxhead, 2025; Mo & Crosthwaite, 2025). Within this instructional ecology, the acquisition of domain-specific vocabulary, the development of genre awareness\u2014defined as learners' capacity to recognize, analyze, and produce texts according to their sociorhetorical conventions\u2014and the cultivation of communicative confidence constitute three foundational yet persistently challenging competencies for non-native English-speaking undergraduates navigating disciplinary communities of practice (Feng et al., 2025; Wu et al., 2025).\n\nThe rapid diffusion of large language models (LLMs), and particularly tools such as ChatGPT, has catalyzed a reconceptualization of how learners access, generate, and negotiate language in academic settings (Barrett & Pack, 2023; Kim et al., 2024a). Unlike earlier computer-assisted language learning (CALL) technologies, GenAI systems are capable of producing contextually sensitive, genre-appropriate, and lexically rich outputs that can be tailored to disciplinary registers upon learner prompting, thereby offering qualitatively distinct scaffolding opportunities unavailable in prior technological generations (Kartal & Ye\u015filyurt, 2024; Law, 2024). Scholars have observed that the interactivity, immediacy, and adaptive responsiveness of GenAI systems may function as low-anxiety environments for rehearsing disciplinary communication, potentially attenuating the affective barriers\u2014particularly foreign language anxiety and self-efficacy deficits\u2014that systematically constrain undergraduate ESP learners' communicative participation (Song & Song, 2023; Li et al., 2024).\n\nDespite growing enthusiasm for GenAI in language education, substantive empirical evidence concerning its specific effects on the three inter-related competency domains of discipline-specific vocabulary, genre awareness, and communicative confidence within ESP contexts remains remarkably sparse (Chemnad & Othman, 2024; Seufert, 2024). Extant literature has predominantly examined GenAI\u2019s impact on general writing quality (Fleckenstein et al., 2023; Link et al., 2024), overall academic performance (Lo et al., 2024; He et al., 2025), and student attitudes toward AI-assisted learning (Yan et al., 2024; Neupane et al., 2024), with comparatively limited attention accorded to the differential acquisition trajectories of domain-specific lexical competence and genre-rhetorical sophistication as distinct constructs (Ballance & Coxhead, 2025; Mo & Crosthwaite, 2025). Furthermore, research conducted in Global South institutional contexts\u2014where English remains an additional language at both the personal and institutional levels and where GenAI literacy among students is emergent rather than established\u2014is conspicuously underrepresented in the current evidence base (Rahmatullah et al., 2026; Siagian et al., 2026; Monje & Madera, 2024). Indonesian undergraduate students within Islamic higher education institutions, operating within a distinctive intersection of religious, disciplinary, and linguistic identity, constitute a particularly relevant yet understudied population in this regard (Ng et al., 2024).\n\nA further theoretical gap concerns the mechanisms through which GenAI mediates genre awareness development. While Swales\u2019 (1990) genre-as-social-action framework and Bakhtin's (1986) conceptualization of dialogic utterance have informed conventional ESP genre pedagogy (Chen et al., 2025; Wang, 2024), their application to AI-mediated instructional settings\u2014where genre negotiation occurs iteratively through human-AI dialogue\u2014remains theoretically underdeveloped (Mashagbeh et al., 2025; Caffaratti et al., 2025). Similarly, the relationship between AI-assisted rehearsal and the affective dimensions of communicative competence, specifically communicative confidence, has not been adequately theorized within Vygotskian sociocultural frameworks that emphasize the mediational role of technological tools in higher-order cognitive and affective development (Kinskofer & Tulis, 2025; Jose et al., 2025).\n\nThis study addresses these identified gaps through a mixed-methods quasi-experimental investigation of 45 undergraduate students within the Department of Islamic Education at STAI Diponegoro Tulungagung, Indonesia. Specifically, it examines: (a) whether GenAI-integrated ESP instruction produces statistically significant improvements in discipline-specific vocabulary acquisition compared to conventional instruction; (b) whether such instruction produces measurable gains in genre awareness as assessed through a validated rubric; (c) whether exposure to GenAI-assisted communicative practice yields enhanced communicative confidence; and (d) what qualitative mechanisms students identify as underpinning their learning experiences within GenAI-integrated ESP environments. The study makes three substantive contributions: it provides context-sensitive empirical evidence from an understudied Indonesian Islamic higher education context; it theorizes the GenAI-genre awareness interface through an integration of Swales' genre pedagogy and Vygotskian mediation theory; and it offers actionable pedagogical implications for ESP instructors navigating the integration of AI tools within discipline-specific language curricula.\n\n2. Literature Review and Theoretical Framework";
  const revisedText = "This mixed-methods quasi-experimental study examined whether Generative Artificial Intelligence (GenAI)-integrated English for Specific Purposes (ESP) instruction improves undergraduate students\u2019 discipline-specific vocabulary acquisition, genre awareness, and communicative confidence. Forty-five students from the Department of Islamic Education at STAI Diponegoro Tulungagung, Indonesia, participated in an eight-week intervention comprising an experimental group receiving GenAI-assisted ESP instruction and a control group receiving conventional instruction. Data were collected through a Discipline-Specific Vocabulary Test, a Genre Awareness Assessment Rubric, a Communicative Confidence Scale, and semi-structured interviews. Paired- and independent-samples t-tests indicated statistically significant and substantively meaningful gains for the experimental group across all three domains, while qualitative findings highlighted scaffolded vocabulary discovery, iterative genre negotiation, reduced communicative anxiety, and emergent critical-reflexive AI literacy. The study provides context-sensitive evidence for the pedagogical value of GenAI in higher-education ESP settings and offers practical implications for language educators.";
  return {
    ...
    revisions:[
      {section:'Abstract', action:'Refined academic tone and strengthened methodological precision.'},
      {section:'Introduction', action:'Improved gap articulation and tightened literature framing.'},
      {section:'Discussion', action:'Enhanced interpretive linkage between findings and theory.'}
    ],
    analysis:{
      ...
      paragraphs: 8,
      issues:[
        {type:'Academic Tone', detail:'Several sentences benefited from tighter hedging and more formal reporting verbs.', suggestion:'Use more cautious claims and precise research verbs.', severity:'medium'},
        {type:'Clarity', detail:'A few long sentences in the introduction reduced readability.', suggestion:'Break extended sentences into shorter analytical units.', severity:'medium'},
        {type:'Citation', detail:'Reference formatting required consistency checking for punctuation and capitalization.', suggestion:'Apply APA 7th formatting consistently across the list.', severity:'low'},
        {type:'Journal Readiness', detail:'The manuscript was strong overall but benefited from a final pre-submission verification.', suggestion:'Conduct a final author check before submission.', severity:'low'}
      ],
...
function openAdminPortal(){ route('admin'); }
function togglePortalAdmin(show){ if(show) route('admin'); }
function portalAdminLogin(){ portalUnlock(); }
...
function renderMetrics(){
  ...
  const first = getProject(activeProjectId) || projects[0];
  if(first?.analysis?.scores?.overall && $('homeScore')) $('homeScore').textContent = first.analysis.scores.overall;
  if(first?.analysis?.recommendation && $('homeRecommendation')) $('homeRecommendation').textContent = first.analysis.recommendation;
}

function renderHomeShowcase(){
  const p = getProject(activeProjectId) || getProjects()[0];
  if(!p) return;
  ...
  if($('featuredStatus')) $('featuredStatus').textContent = p.proofreadStatus;
  if($('homeTimeline')) $('homeTimeline').innerHTML = (p.tracking||[]).slice(0,6).map((t,i)=>`<div class="mini-step"><span>${i+1}</span><div><strong>${safe(t.title)}</strong><small>${safe(t.date)}</small></div></div>`).join('');
  ...
  if($('homeCostTable')) {
    const rows = (p.costBreakdown||[]).map(r=>`<tr><td>${safe(r.stage)}</td><td>${safe(r.result)}</td><td>${money(r.amount)}</td></tr>`).join('');
    $('homeCostTable').innerHTML = `<thead><tr><th>Workflow Stage</th><th>Result</th><th>Amount</th></tr></thead><tbody>${rows}</tbody><tfoot><tr><th colspan="2">Total Project Fee</th><th>${money(p.amount)}</th></tr></tfoot>`;
  }
}
...
function fillSample(){
  ...
  $('deadline').value=p.deadline; $('packageName').value=p.packageId; $('wordCount').value=String(p.wordCount); $('urgency').value=p.urgency;
  $('documentText').value=p.documentText;
  updatePackageInfo(); toast('Real project sample inserted.');
}
...
function adminLogin(){
  if(($('adminPin').value || '') === ADMIN_PIN){ grantAccess(); sessionStorage.setItem('aps_admin','1'); $('adminPin').value=''; renderAdminState(); toast('Admin unlocked.'); }
